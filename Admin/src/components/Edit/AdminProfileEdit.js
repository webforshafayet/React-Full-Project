...
const AdminProfileEdit = () => {
  ...
  const [education, seteducation] = useState(user[0].education);
  ...
  const editeducation = (e) => {
    ...
    const edited_education = education;
    user[0].education = edited_education;
  };

  const editexperience = (e) => {
    setexperience(e.target.value);
    const edited_experience = experience;
    user[0].experience = edited_experience;
  };
